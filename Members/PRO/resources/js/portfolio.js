        ...
        card.addEventListener("click", () => {
            if (card.classList.contains("web")) {
                ...
                portfolioView({
                    ...
                    category: "Web Thương Mại",
                    project_brief: `Koi Farm Shop là một website thương mại điện tử chuyên cung cấp cá Koi và các sản phẩm chăm sóc cá Koi.
                     Dự án nhằm giúp khách hàng dễ dàng đặt hàng, tìm kiếm sản phẩm và theo dõi khuyến mãi đặc biệt một cách nhanh chóng.
`,

                    project_date: "2024",
                    project_client: "KoiFarmTeam",
                    project_link: `www.${website}.com`,

                    image: [
                        "resources/img/portfolios/web/1.jpg",
                        "resources/img/portfolios/web/11.jpg",
                        "resources/img/portfolios/web/111.jpg",
                ...
                portfolioView({
                    ...
                    project_brief: `                                Đây là một hệ thống quản lý khách sạn hỗ trợ nhân viên tiếp tân, kế toán và ban quản lý theo dõi đặt phòng, hóa đơn, khách hàng và dịch vụ. Giao diện thân thiện, hỗ trợ nhiều chức năng như đặt phòng trực tuyến, báo cáo doanh thu và thống kê chi tiết theo ngày/tháng.
`,
